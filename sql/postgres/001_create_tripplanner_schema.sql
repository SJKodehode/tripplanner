/*
    ...
    Bootstrap script: schema + core tables.
*/
...
CREATE TABLE IF NOT EXISTS app.trip_members (
...
CREATE TABLE IF NOT EXISTS app.trip_days (
...
CREATE TABLE IF NOT EXISTS app.feed_comments (
...
CREATE INDEX IF NOT EXISTS ix_trip_members_user_id
  ON app.trip_members (user_id);

CREATE INDEX IF NOT EXISTS ix_feed_posts_trip_id_created_at
  ON app.feed_posts (trip_id, created_at DESC);

CREATE INDEX IF NOT EXISTS ix_feed_posts_trip_day_id_created_at
  ON app.feed_posts (trip_day_id, created_at DESC);

CREATE INDEX IF NOT EXISTS ix_feed_comments_feed_post_id_created_at
